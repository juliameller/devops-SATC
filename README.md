...
## SRE
A SRE (Site Reliability Engineering) visa aprimorar a automação da repetibilidade e da previsibilidade, aumentar a escalabilidade para um crescimento que não interrompa o serviço e garantir a confiabilidade. Os membros da equipe de SRE podem atuar como recursos híbridos de administração de sistemas/desenvolvimento, concentrando a atenção onde e quando for necessário. Eles podem identificar e corrigir problemas. A SRE ajuda as equipes de desenvolvimento e operações a trabalharem juntas de forma mais eficaz para atingir objetivos comuns, graças à sua capacidade de transitar fluidamente entre as duas áreas.
## DevOps
